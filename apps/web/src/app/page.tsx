    ...
    <main className="relative min-h-screen overflow-hidden">
      ...
      <div className="mx-auto flex min-h-screen max-w-6xl flex-col items-start justify-center px-6 py-24 text-white">
        ...
        <p className="mt-6 max-w-xl text-lg text-white/80 md:text-xl">
          FoxEats livre les meilleures adresses du sud de la France en quelques minutes. Spécialités
          locales, restaurateurs sélectionnés, livreurs équitablement rémunérés.
        </p>
        ...
        <p className="mt-16 text-sm text-white/60">
          Site en construction · v0 · cahier des charges dans{' '}
          <code className="rounded bg-white/10 px-1">docs/SPEC.md</code>
        </p>
      </div>
    </main>
  );
